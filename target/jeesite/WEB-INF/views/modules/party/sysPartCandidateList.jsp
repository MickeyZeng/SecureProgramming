...
<body>
	...
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/party/sysPartCandidate/">Party List</a></li>
		...
		<c:forEach items="${page.list}" var="sysPartCandidate">
			<tr>
				...
				<shiro:hasPermission name="party:sysPartCandidate:edit"><td>
    				<a href="${ctx}/party/sysPartCandidate/form?id=${sysPartCandidate.id}">update</a>
					<a href="${ctx}/party/sysPartCandidate/delete?id=${sysPartCandidate.id}" onclick="return confirmx('确认要删除该Party吗？', this.href)">Delete</a>
