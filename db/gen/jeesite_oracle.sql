...
COMMENT ON COLUMN gen_scheme.update_date IS 'Update Time';
COMMENT ON COLUMN gen_scheme.remarks IS 'Recomment';
COMMENT ON COLUMN gen_scheme.del_flag IS '删除标记（0：正常；1：Delete）';
...
COMMENT ON COLUMN gen_table.update_date IS 'Update Time';
COMMENT ON COLUMN gen_table.remarks IS 'Recomment';
COMMENT ON COLUMN gen_table.del_flag IS '删除标记（0：正常；1：Delete）';
...
COMMENT ON COLUMN gen_table_column.update_date IS 'Update Time';
COMMENT ON COLUMN gen_table_column.remarks IS 'Recomment';
COMMENT ON COLUMN gen_table_column.del_flag IS '删除标记（0：正常；1：Delete）';
...
COMMENT ON COLUMN gen_template.update_date IS 'Update Time';
COMMENT ON COLUMN gen_template.remarks IS 'Recomment';
COMMENT ON COLUMN gen_template.del_flag IS '删除标记（0：正常；1：Delete）';
