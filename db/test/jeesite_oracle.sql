...
COMMENT ON COLUMN test_data.id IS 'ID';
...
COMMENT ON COLUMN test_data.update_date IS 'Update Time';
COMMENT ON COLUMN test_data.remarks IS 'Recomment';
COMMENT ON COLUMN test_data.del_flag IS '删除标记';
COMMENT ON TABLE test_data_child IS '业务数据子表';
COMMENT ON COLUMN test_data_child.id IS 'ID';
...
COMMENT ON COLUMN test_data_child.update_date IS 'Update Time';
COMMENT ON COLUMN test_data_child.remarks IS 'Recomment';
COMMENT ON COLUMN test_data_child.del_flag IS '删除标记';
COMMENT ON TABLE test_data_main IS '业务数据表';
COMMENT ON COLUMN test_data_main.id IS 'ID';
...
COMMENT ON COLUMN test_data_main.update_date IS 'Update Time';
COMMENT ON COLUMN test_data_main.remarks IS 'Recomment';
COMMENT ON COLUMN test_data_main.del_flag IS '删除标记';
COMMENT ON TABLE test_tree IS '树结构表';
COMMENT ON COLUMN test_tree.id IS 'ID';
...
COMMENT ON COLUMN test_tree.update_date IS 'Update Time';
COMMENT ON COLUMN test_tree.remarks IS 'Recomment';
