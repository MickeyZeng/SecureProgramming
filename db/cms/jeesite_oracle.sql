...
COMMENT ON COLUMN cms_article.id IS 'ID';
...
COMMENT ON COLUMN cms_article.update_date IS 'Update Time';
COMMENT ON COLUMN cms_article.remarks IS 'Recomment';
COMMENT ON COLUMN cms_article.del_flag IS '删除标记';
COMMENT ON TABLE cms_article_data IS '文章详表';
COMMENT ON COLUMN cms_article_data.id IS 'ID';
...
COMMENT ON COLUMN cms_category.id IS 'ID';
...
COMMENT ON COLUMN cms_category.update_date IS 'Update Time';
COMMENT ON COLUMN cms_category.remarks IS 'Recomment';
COMMENT ON COLUMN cms_category.del_flag IS '删除标记';
COMMENT ON TABLE cms_comment IS '评论表';
COMMENT ON COLUMN cms_comment.id IS 'ID';
...
COMMENT ON COLUMN cms_guestbook.id IS 'ID';
...
COMMENT ON COLUMN cms_link.id IS 'ID';
...
COMMENT ON COLUMN cms_link.update_date IS 'Update Time';
COMMENT ON COLUMN cms_link.remarks IS 'Recomment';
COMMENT ON COLUMN cms_link.del_flag IS '删除标记';
COMMENT ON TABLE cms_site IS '站点表';
COMMENT ON COLUMN cms_site.id IS 'ID';
...
COMMENT ON COLUMN cms_site.update_date IS 'Update Time';
COMMENT ON COLUMN cms_site.remarks IS 'Recomment';
