...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/resultparty/sysResultParty/">resultParty列表</a></li>
		<shiro:hasPermission name="resultparty:sysResultParty:edit"><li><a href="${ctx}/resultparty/sysResultParty/form">resultParty添加</a></li></shiro:hasPermission>
	</ul>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th>更新时间</th>
				<th>备注信息</th>
				<shiro:hasPermission name="resultparty:sysResultParty:edit"><th>操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="sysResultParty">
			<tr>
				...
				<shiro:hasPermission name="resultparty:sysResultParty:edit"><td>
    				<a href="${ctx}/resultparty/sysResultParty/form?id=${sysResultParty.id}">修改</a>
					<a href="${ctx}/resultparty/sysResultParty/delete?id=${sysResultParty.id}" onclick="return confirmx('确认要删除该resultParty吗？', this.href)">删除</a>
