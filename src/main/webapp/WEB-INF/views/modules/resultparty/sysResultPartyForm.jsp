...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/resultparty/sysResultParty/form?id=${sysResultParty.id}">resultParty<shiro:hasPermission name="resultparty:sysResultParty:edit">${not empty sysResultParty.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="resultparty:sysResultParty:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="sysResultParty" action="${ctx}/resultparty/sysResultParty/save" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="resultparty:sysResultParty:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
