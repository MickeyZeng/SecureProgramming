...
<body>
	...
	<form:form id="inputForm" modelAttribute="sysResultCandidate" action="${ctx}/resultcandidate/sysResultCandidate/save" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="resultcandidate:sysResultCandidate:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
