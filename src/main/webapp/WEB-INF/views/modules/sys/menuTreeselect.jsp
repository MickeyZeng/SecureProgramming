...
<script type="text/javascript"> 
	...
	var menuTreeselectNodes=[
			...
			</c:if></c:forEach>{id:new Date().getTime(), pId:"0", name:"<i class=\"icon-home\"></i>&nbsp;HomePage", url:"${ctx}", target:"_self"},
			{id:new Date().getTime(), pId:"0", name:"<i class=\"icon-share\"></i>&nbsp;SignOut", url:"${ctx}/logout", target:"_self"}];
