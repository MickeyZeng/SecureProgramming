...
<%--						<a class="dropdown-toggle" data-toggle="dropdown" href="#" title="主题切换"><i class="icon-th-large"></i></a>--%>
						<ul class="dropdown-menu">
							...
							<li><a href="javascript:cookie('tabmode','${cookie.tabmode.value eq '1' ? '0' : '1'}');location=location.href">${cookie.tabmode.value eq '1' ? 'Close' : 'Open'}Tag Mode</a></li>
...
<%--							<li><a href="${ctx}/sys/user/modifyPwd" target="mainFrame"><i class="icon-lock"></i>&nbsp;  修改密码</a></li>--%>
							<li><a href="${ctx}/oa/oaNotify/self" target="mainFrame"><i class="icon-bell"></i>&nbsp;  My Info <span id="notifyNum2" class="label label-info hide"></span></a></li>
<%--							<li><a href="${ctx}/oa/oaNotify/self" target="mainFrame"><i class="icon-bell"></i>&nbsp;  我的通知 <span id="notifyNum2" class="label label-info hide"></span></a></li>--%>
						</ul>
					</li>
					<li><a href="${ctx}/logout" title="Sign Out">Sign Out</a></li>
